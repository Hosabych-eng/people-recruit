      ...
      categories: [
        {
          key: "recruitingIn",
          label: "Нові заявки",
          description: "Кандидати увійшли до воронки найму",
          type: WorkforceEventType.RECRUITING_IN,
        },
        {
          key: "recruitingOut",
          label: "Закриті заявки",
          description: "Відмови, відкликання або видалення з воронки",
          type: WorkforceEventType.RECRUITING_OUT,
        },
        {
          key: "onboarding",
          label: "Онбординг",
          description: "Люди, які завершили найм і розпочали адаптацію",
          type: WorkforceEventType.ONBOARDING,
        },
        {
          key: "offboarding",
          label: "Офбординг",
          description: "Люди, які залишили компанію за період",
