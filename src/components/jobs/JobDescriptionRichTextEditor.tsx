...
type JobDescriptionRichTextEditorProps = {
  value: string;
...
function syncEditorContent(editor: Editor | null | undefined, value: string) {
  if (!editor) return;
...
export function JobDescriptionRichTextEditor({
  value,
  onChange,
  placeholder = "Натисніть тут, щоб додати опис вакансії…",
  disabled = false,
}: JobDescriptionRichTextEditorProps) {
